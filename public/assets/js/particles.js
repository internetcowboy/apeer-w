 ...
 * 
 */
var settings = {"ParticleCount":250,"ParticleOpacity":70,"LineOpacity":70,"Size":1,"AnimationSpeed":1,"LinkParticles":true,"Animate":true,"Interactive":true,"AddOnClick":true,"image":"http:\/\/payload.persona.co\/1\/0\/118\/655\/CB68c_1000.jpg","plugin_id":0};
	
	// Is mobile, change some settings
	if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
		settings.ParticleCount = settings.ParticleCount / 2;
		settings.LineOpacity = 70;
...
$(document).ready(function() {
	...
	particlesJS('particles-js', {
			particles: {
				...
				opacity: (settings.ParticleOpacity / 100),
				size: settings.Size,
				size_random: settings.RandomSize,
				nb: settings.ParticleCount,
				line_linked: {
					enable_auto: settings.LinkParticles,
					distance: 100,
					color: '#b6ab88',
				...
				anim: {
					enable: settings.Animate,
					speed: settings.AnimationSpeed
				}
			},
			interactivity: {
				enable: settings.Interactive,
				mouse: {
					distance: 300
				},
